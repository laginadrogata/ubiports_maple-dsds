...
#define TAG_BEGIN_MINOR_LOG "===== BEGIN MINOR LOG =====\n"
#define TAG_END_MINOR_LOG "===== END MINOR LOG =====\n"
...
class SignalCatcher {
 ...
 private:
  ...
  void HandleSigUsr1();
  void CookOutputString(const std::string& s, std::string& full_str, std::string& mini_str);
