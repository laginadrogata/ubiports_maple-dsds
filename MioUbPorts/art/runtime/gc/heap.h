...
#if defined(GC_DUMP)
  void DumpGcForAllocInfo(std::ostream& os, Thread* self, const std::string& gc_cause,
      bool isDumpAllocationStack = false) REQUIRES_SHARED(Locks::mutator_lock_);
  void DumpAllocationStackInfo(std::ostream& os)
      REQUIRES_SHARED(Locks::mutator_lock_);
#endif
