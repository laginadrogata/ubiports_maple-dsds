ifneq ($(wildcard kernel/msm-*),)
KERNEL_PATH := kernel/msm-*
else
KERNEL_PATH := kernel
endif
...
ifneq ($(wildcard $(KERNEL_PATH)/include/soc/qcom/glink.h),)
ifneq ($(wildcard $(KERNEL_PATH)/include/soc/qcom/tracer_pkt.h),)
